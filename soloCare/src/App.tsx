  ...
  <IonApp>
    <IonReactRouter>
      <IonRouterOutlet>
        ...
        <Route exact path='/applicationSubmit' component={applicationSubmit}></Route>
        <Route exact path='/applicationStatuspending' component={applicationStatuspending}></Route>
        <Route exact path='/applicationStatusrejected' component={applicationStatusrejected}></Route>
        <Route exact path='/applicationStatusapproved' component={applicationStatusapproved}></Route>
